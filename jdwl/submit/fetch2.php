...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<button type="button" href="#" name="open_modal" class="open_modal btn btn-sm btn-primary" data-id="'.$row['id_job'].'"><i class="glyphicon glyphicon-pencil"></i>Edit</a><i></i>';
 $sub_array[] =   '<button type="button" name="delete_product" data-id="'.$row['id_job'].'" class="btn btn-sm delete_product"><i class="glyphicon glyphicon-trash"></i>Delete</button>';
